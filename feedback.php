...
if(isset($_GET['error'])) {
    if($_GET['error'] === 'invalidemail') {
        echo '<script>alert("Неверный email")</script>';
...
<div class="container mb-4">
  <h1> <i class="far fa-comment-alt"></i> Отзыв</h1>
      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Каким было ваше первое впечатление
                  когда вы зашли на сайт?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option  selected disabled>Как вы впервые услышали о нас?</option>
                <option >Поисковая машина</option>
                <option >Социальные сети</option>
                <option >Друг/родственник</option>
                <option >Слышал от знакомых</option>
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Чего-нибудь не хватает на этой странице?</label>     
