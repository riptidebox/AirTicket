...
if(isset($_GET['error'])) {
    if($_GET['error'] === 'invalidcred') {
        echo '<script>alert("Некорретные данные")</script>';
...
<div class="container mt-0">
  <div class="row">
    <div class="col-md-3"></div>
      ...
      <h1 class="text-secondary text-center">Авторизация</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row">  
          ...
          <div class="col-10 mb-2">              
            <div class="input-group">
                <label for="user_id">Логин / Email</label>
        ...
        <div class="row mt-3">
          ...
          <a id="reset-pass" class="mr-5" href="reset-pwd.php"
              style="float: right !important;">Забыли пароль</a>        
          </div>         
        </div>   
        <div class="row mt-4">
          <div class="col">
          ...
          <div class="col">
            <button name="login_but" type="submit" 
              ...
              <div style="font-size: 1.5rem;">
              <i class="fa fa-lg fa-arrow-right"></i> Войти
              </div>
            </button>
          </div>       
        </div>       
