...
<?php
  if(isset($_GET['error'])) {
    if($_GET['error'] === 'sqlerror') {
        echo"<script>alert('Ошибка базы данных')</script>";
    } else if($_GET['error'] === 'noret') {
      echo"<script>alert('Обратный рейс недоступен')</script>";
    } else if($_GET['error'] === 'mailerr') {
      echo"<script>alert('Ошибка почты')</script>";
    }
  }
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">Пополнить счет</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    ...
                    <span class="invalid-feedback">Введите действительный номер карты из 12-16 цифр</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="cc-exp" class="control-label mb-1">Истечение</label>
                            <input id="cc-exp" name="cc-exp" type="tel" class="form-control cc-exp" required placeholder="MM / YY" autocomplete="cc-exp">
                            <span class="invalid-feedback">Введите дату истечения срока годности</span>
                        </div>
                    </div>
                    <div class="col-6 p-0">
                        <label for="x_card_code" class="control-label mb-1">CVV код</label>
                        <div class="row">
                            <div class="col pr-0">
                                <input id="x_card_code" name="x_card_code" type="password" class="form-control cc-cvc" required autocomplete="off">
                            </div>
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Введите 3-значный код на обратной стороне</span>
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                    <span class="fa fa-question-circle fa-lg" data-toggle="popover" data-container="body" data-html="true" data-title="CVV" 
                                    data-content="<div class='text-center one-card'>3-значный код на обратной стороне карты..<div class='visa-mc-cvc-preview'></div></div>"
                ...
                <div class='col-md-12 mb-2'>
                    ...
                    class="btn btn-lg btn-primary btn-block">
                        ...
                        <span id="payment-button-amount">Оплатить </span>
    ...
    if (form[0].checkValidity() === false) {
      ...
      e.stopPropagation();
       ...
       if (!regCardNo.test(CardNo)) {
        ...
        $("#cc-number").focus();
        alert(" Введите действительный номер карты от 10 до 16");
        return false;
      }
        ...
        $("#cc_exp").focus();
        alert(" Введите действительную дату exp");
        return false;
      }
