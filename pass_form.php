...
<?php
    if(isset($_GET['error'])) {
        if($_GET['error'] === 'invdate') {
          echo '<script>alert("Неверная дата рождения")</script>';
      } else if($_GET['error'] === 'moblen') {
          echo '<script>alert("Неверная контактная информация")</script>';
...
<main>
    ...
    <div class="col-md-12 main-col">
        <h1 class="text-center text-secondary">СВЕДЕНИЯ О ПАССАЖИРЕ</h1>  
        ...
        <?php for($i=1;$i<=$passengers;$i++) {
            ...
            <div class="form-row">
                <div class="col-md">
                    <div class="input-group">
                        <label for="firstname'.$i.'">Имя</label>
                ...
                <div class="col-md">
                    <div class="input-group">
                        <label for="midname'.$i.'">Отчество</label>
            ...
            <div class="col text-center">
                ...
                <i class="fa fa-lg fa-arrow-right"></i>Продолжить  
                </div>
                </button>
            </div>         
        </form>              
