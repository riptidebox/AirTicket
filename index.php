...
<?php
    if(isset($_GET['error'])) {
        if($_GET['error'] === 'sameval') {
		  echo '<script>alert("Выберите другое направление для отправления и прилета")</script>';
      } else if($_GET['error'] === 'seldep') {
          echo '<script>alert("Выберите город отправления")</script>';
      } else if($_GET['error'] === 'selarr') {
          echo"<script>alert('Выберите город прилета')</script>";
      }
    }
?>
<link rel="stylesheet" type="text/css"
	...
	<div class="main-agileinfo">
		...
		Поиск авиабилетов</h1>
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Туда и обратно</span></li>
					<li class="resp-tab-item"><span>В одну сторону</span></li>
				</ul>	
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								<h3 style="color: rgba(255, 255, 255, 0.767);">Откуда</h3>
								<?php
							...
							<div class="to">
								<h3 style="color: rgba(255, 255, 255, 0.767);">Куда</h3>
								<?php
								$sql = 'SELECT * FROM Cities ';
								$stmt = mysqli_stmt_init($conn);
								mysqli_stmt_prepare($stmt,$sql);         
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Кол-во пассажиров</h3>
									<div class="quantity"> 
							...
							<div class="clear"></div>
							<input type="submit" value="Поиск" name="search_but">
						</form>						
					</div>		
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4  intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Лучшие направления</div>
                                            <div class="intro_subtitle">
                                                <p>Что есть в вашем списке обязательных поездок?</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Лучшие цены</div>
                                            <div class="intro_subtitle">
                                                <p>Посетите ваши любимые места по отличной цене</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Отличный сервис</div>
                                            <div class="intro_subtitle">
                                                <p>Отличное взаимодействие начинается с понимания желаний и потребностей ваших клиентов.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
