...
<main>
  <?php if(isset($_SESSION['userId'])) {   
    ...
    <h1 class="text-center text-light mt-4 mb-4">ЭЛЕКТРОННЫЙ БИЛЕТ</h1>
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                        ...
                        <div class="col-3 pl-0" style="background-color:#376b8d !important;
                            ...
                            <div class="row">
                                ...
                                &nbsp Спасибо что выбрали нашу компанию. </br> </br>
                                ...
                                <div class="dropdown-menu">
                                    <form class="px-4 py-3"  action="ticket.php" 
                                        ...
                                        <button class="btn btn-danger btn-sm"
                                            name="cancel_but">
                                            <i class="fa fa-trash"></i> &nbsp; Отменить бронь билета</button>
                                    </form>
                                    <form class="px-4 py-3" action="e_ticket.php" target="_blank"
                                        ...
                                        <button class="btn w-100 mb-3 btn-primary btn-sm"
                                            name="print_but">
                                            <i class="fa fa-print"></i> &nbsp; Печать талона</button>
                                    </form>                                    
                                </div>
                            </div>              
                        </div>                          
